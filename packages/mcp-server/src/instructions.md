...
- Tool results carry a short text summary plus the full payload in `structuredContent`. Read `structuredContent` for complete code, token, and asset data; the text block alone is not the response.
